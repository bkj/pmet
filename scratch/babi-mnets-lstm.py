...
emb_x1 = LSTM(emb_dim, return_sequences=True)(emb_x1)
...
emb_x2 = LSTM(emb_dim, return_sequences=True)(emb_x2)
...
# !! Makes sense that this isn't working -- mask doesn't take order into account
